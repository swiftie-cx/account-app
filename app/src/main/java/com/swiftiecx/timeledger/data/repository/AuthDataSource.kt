    ...
    private fun mapAuthError(e: Exception): String {
        ...
        return when (e) {
            is FirebaseAuthInvalidUserException ->
                getString(com.swiftiecx.timeledger.R.string.error_email_or_password_wrong, emptyArray())

            is FirebaseAuthInvalidCredentialsException ->
                getString(com.swiftiecx.timeledger.R.string.error_email_or_password_wrong, emptyArray())

            is FirebaseAuthUserCollisionException ->
                getString(com.swiftiecx.timeledger.R.string.error_email_already_registered, emptyArray())

            is FirebaseAuthRecentLoginRequiredException ->
                getString(com.swiftiecx.timeledger.R.string.error_recent_login_required, emptyArray())

            is FirebaseNetworkException ->
                getString(com.swiftiecx.timeledger.R.string.error_network_check, emptyArray())
